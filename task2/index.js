...
buttonLogin.addEventListener('click', () => openPopUpLogin.openForm(loginForm.form.closest('.modal')));
buttonRegistration.addEventListener('click', () => openPopUpReg.openForm(regForm.form.closest('.modal')));